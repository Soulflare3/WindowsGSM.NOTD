...
{
    public class NOTD : SteamCMDAgent // SteamCMDAgent is used because GMOD relies on SteamCMD for installation and update process
    {
        // - Plugin Details
        public Plugin Plugin = new Plugin
        {
            ...
            version = "1.1",
            url = "https://github.com/GeekbeeGER/WindowsGSM.NOTD", // Github repository link (Best practice)
            color = "#9eff99" // Color Hex
        };


        // - Standard Constructor and properties
        public NOTD(ServerConfig serverData) : base(serverData) => base.serverData = _serverData = serverData;
        ...
        public override string AppId => "1420710"; // Game server appId, GMOD is 4020


        // - Game server Fixed variables
        public override string StartPath => @"LF\Binaries\Win64\LFServer-Win64-Shipping.exe"; // Game server start path, for GMOD, it is srcds.exe
        public string FullName = "NOTD Dedicated Server"; // Game server FullName
        ...
        public string Additional = "?listen -log -CRASHREPORTS"; // Additional server start parameter
